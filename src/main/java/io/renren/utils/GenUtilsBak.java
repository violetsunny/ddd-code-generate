...
public class GenUtilsBak {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templatebak/Dao.xml.vm");

        templates.add("templatebak/menu.sql.vm");

        templates.add("templatebak/Service.java.vm");
        templates.add("templatebak/ServiceImpl.java.vm");
        templates.add("templatebak/Controller.java.vm");
        templates.add("templatebak/Dao.java.vm");

        templates.add("templatebak/index.vue.vm");
        templates.add("templatebak/add-or-update.vue.vm");
    ...
    public static List<String> getMongoChildTemplates() {
        List<String> templates = new ArrayList<String>();
        templates.add("templatebak/MongoChildrenEntity.java.vm");
        return templates;
    }
    ...
    public static Configuration getConfig() {
        try {
            return new PropertiesConfiguration("generator-bak.properties");
